...
const cancel_order_entity_1 = require("../../entities/cancel_order.entity");
let CancelOrderRepository = class CancelOrderRepository extends base_abstract_repository_1.BaseRepositoryAbstract {
    constructor(cancelOrderRepository) {
...
exports.CancelOrderRepository = CancelOrderRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(cancel_order_entity_1.CancelOrder)),
